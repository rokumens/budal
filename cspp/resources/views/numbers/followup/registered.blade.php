    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <main role="main" class="container">
          ...
          <div class="my-3 p-3 bg-white rounded box-shadow">
            <h6 class="border-bottom border-gray pb-2 mb-0">Basic information</h6>
            <div class="media text-muted pt-3">
              <img data-src="holder.js/32x32?theme=thumb&bg=007bff&fg=007bff&size=1" alt="" class="mr-2 rounded">
              <p class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
  ...
  <div class="modal-dialog modal-md" style="max-width:800px !important;">
    {{ Form::open(array('method' => 'PUT','id'=>'classForm','class'=>'form-horizontal classFormUpdate')) }}
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="form-group has-feedback row {{ $errors->has('is_deposit') ? ' has-error ' : '' }}">
            {!! Form::label('is_deposit', trans('Already deposit?'), array('class' => 'col-md-3 control-label')); !!}
            <div class="col-md-9">
              <div class="input-group">
                <select name="is_deposit" id="is_deposit" class="form-control">
          ...
          <div class="form-group has-feedback row {{ $errors->has('note_registered') ? ' has-error ' : '' }}">
            {!! Form::label('note_registered', trans('Notes'), array('class' => 'col-md-3 control-label')); !!}
            <div class="col-md-9">
              <div class="input-group">
                <textarea name="note_registered" class="form-control notes_id" id="note_registered" rows="3" required placeholder="Tell us this number registered..."></textarea>
              </div>
            </div>
          </div>
        </div>
