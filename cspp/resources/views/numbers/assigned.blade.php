...
<div id="editModal" class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-md" style="max-width:800px !important;">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="form-group has-feedback row {{ $errors->has('is_contacted') ? ' has-error ' : '' }}">
              {!! Form::label('is_contacted', trans('Already contacted?'), array('class' => 'col-md-3 control-label')); !!}
              <div class="col-md-9">
                  <div class="input-group">
                    <select name="is_contacted" id="is_contacted" class="form-control" required>
