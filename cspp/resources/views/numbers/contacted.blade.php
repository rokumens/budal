  ...
  <div class="content">
    <div class="card">
      <div class="card-header">
        <h2 class="card-title">Contacted</h2>
      </div>
      <div class="card-body">
        <div class="row">
  ...
  <div class="modal-dialog modal-md" style="max-width:800px !important;">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group has-feedback row {{ $errors->has('campaignresult') ? ' has-error ' : '' }}">
              {!! Form::label('campaignresult', trans('Campaign Result'), array('class' => 'col-md-3 control-label')); !!}
              <div class="col-md-9">
                  <div class="input-group">
                      <select name="campaignresult" id="campaignresult" class="form-control input-sm campaign_result" disabled required>
                          @if ($campaign_result)
          ...
          <div class="form-group has-feedback row {{ $errors->has('note_contacted') ? ' has-error ' : '' }}">
            {!! Form::label('note_contacted', trans('Notes'), array('class' => 'col-md-3 control-label hide_note')); !!}
            <div class="col-md-9">
                <div class="input-group">
                    <textarea style="display : none;" name="note_contacted" class="form-control hide_note" id="note_contacted" rows="3" placeholder="Tell us your call result with this number..." required></textarea>
                </div>
            </div>
          </div>
        </div>
