<div class="row">
    <div class="col-sm-8 offset-sm-4 col-md-6 offset-md-6 col-lg-5 offset-lg-7 col-xl-4 offset-xl-8">
        ...
        {!! Form::open(['route' => 'search-livechat', 'method' => 'POST', 'role' => 'form', 'class' => 'needs-validation', 'id' => 'search_livechat']) !!}
            {!! csrf_field() !!}
            <div class="input-group mb-3">
                {!! Form::text('livechat_search_box', NULL, ['id' => 'livechat_search_box', 'class' => 'form-control', 'placeholder' => 'Search Livechat', 'aria-label' => 'Search Livechat', 'required' => false]) !!}
