...
@section('content')
    <div class="row justify-content-center">
        <div class="col-12 col-md-8 col-lg-4">
            <h3 class="text-center mb-4">A1 {{ trans('backpack::base.login') }}</h3>
            <div class="card">
                <div class="card-body">
                        ...
                        <div class="form-group">
                            <div>
                                @if (config('backpack.base.registration_open'))
                                    <div class="">Don't have A1 account yet? <a href="{{ route('backpack.auth.register') }}">{{ trans('backpack::base.register') }} here</a>.</div>
                                @endif
                            </div>
                        </div>
                    </form>
