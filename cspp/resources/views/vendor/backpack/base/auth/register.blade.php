...
@section('content')
    <div class="row justify-content-center">
        <div class="col-12 col-md-8 col-lg-4">
            <h3 class="text-center mb-4">A1 {{ trans('backpack::base.register') }}</h3>
            <div class="card">
                <div class="card-body">
                    <form class="col-md-12 p-t-10" role="form" method="POST" action="{{ route('backpack.auth.register') }}">
                        ...
                        <div class="form-group">
                            <div>
                                <div>
                                    Already have account on A1?
                                    <a href="{{ route('backpack.auth.login') }}">{{ trans('backpack::base.login') }} here</a> &raquo;
                                </div>
                            </div>
                        </div>
                    </form>
