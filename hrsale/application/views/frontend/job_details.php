...
<header class="main-header">
  ...
  <nav class="navbar">
    <div class="container">
      ...
      <!-- luffy 2 January 2020 07:31 pm -->
      <?php
      # recommended image use size: 137px x 40px
      $logoStyle='width:auto;height:40px;';
      ?>
      <img src="<?php echo base_url();?>uploads/logo/job/<?php echo $system[0]->job_logo;?>" style='<?=$logoStyle;?>'> </a>
      <!-- Logo end -->
      <!-- Navs start -->
      <div class="navs">
