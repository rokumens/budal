...
{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('let_staff');?>",  add_info: "", check: "<?php if(isset($_GET['role_id'])) { if(in_array('103',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>", value: "103",  items: [
	...
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view');?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "231", check: "<?php if(isset($_GET['role_id'])) { if(in_array('231',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"}
	]},
	...
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view');?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "232", check: "<?php if(isset($_GET['role_id'])) { if(in_array('232',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view_own');?>",  add_info: "<?php echo $this->lang->line('xin_role_view_own');?>", value: "372", check: "<?php if(isset($_GET['role_id'])) { if(in_array('372',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"}
	]},
	...
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view');?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "233", check: "<?php if(isset($_GET['role_id'])) { if(in_array('233',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view_own');?>",  add_info: "<?php echo $this->lang->line('xin_role_view_own');?>", value: "373", check: "<?php if(isset($_GET['role_id'])) { if(in_array('373',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"}
	]},
	...
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view');?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "234", check: "<?php if(isset($_GET['role_id'])) { if(in_array('234',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"}
	]},
	...
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view');?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "235", check: "<?php if(isset($_GET['role_id'])) { if(in_array('235',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view_own');?>",  add_info: "<?php echo $this->lang->line('xin_role_view_own');?>", value: "390", check: "<?php if(isset($_GET['role_id'])) { if(in_array('390',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"}
	]},
	...
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view');?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "236", check: "<?php if(isset($_GET['role_id'])) { if(in_array('236',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view_own');?>",  add_info: "<?php echo $this->lang->line('xin_role_view_own');?>", value: "375", check: "<?php if(isset($_GET['role_id'])) { if(in_array('375',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"}
	]},
	...
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view');?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "237", check: "<?php if(isset($_GET['role_id'])) { if(in_array('237',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view_own');?>",  add_info: "<?php echo $this->lang->line('xin_role_view_own');?>", value: "376", check: "<?php if(isset($_GET['role_id'])) { if(in_array('376',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"}
	]},
	...
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view');?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "238", check: "<?php if(isset($_GET['role_id'])) { if(in_array('238',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view_own');?>",  add_info: "<?php echo $this->lang->line('xin_role_view_own');?>", value: "377", check: "<?php if(isset($_GET['role_id'])) { if(in_array('377',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"}
	]},
	...
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view');?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "239", check: "<?php if(isset($_GET['role_id'])) { if(in_array('239',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"}
	]}
	]},
	...
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view');?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "249", check: "<?php if(isset($_GET['role_id'])) { if(in_array('249',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"}
	]},
	// luffy 9 Feb 2020 08:26 pm
	{ id: "", class: "role-checkbox-modal", text: "Official Document",  add_info: "<?php echo $this->lang->line('xin_add_edit_delete_role_info');?>", value: "1019", check: "<?php if(isset($_GET['role_id'])) { if(in_array('1019',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>",items: [
	// { id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_enable');?>",  add_info: "<?php echo $this->lang->line('xin_role_enable');?>", value: "5", check: "<?php if(isset($_GET['role_id'])) { if(in_array('5',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
	// { id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_add');?>",  add_info: "<?php echo $this->lang->line('xin_role_add');?>", value: "246", check: "<?php if(isset($_GET['role_id'])) { if(in_array('246',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
	// { id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_edit');?>",  add_info: "<?php echo $this->lang->line('xin_role_add');?>", value: "247", check: "<?php if(isset($_GET['role_id'])) { if(in_array('247',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
	// { id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_delete');?>",  add_info: "<?php echo $this->lang->line('xin_role_add');?>", value: "248", check: "<?php if(isset($_GET['role_id'])) { if(in_array('248',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
	...
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view');?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "253", check: "<?php if(isset($_GET['role_id'])) { if(in_array('253',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"}
	]},
	...
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view');?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "257", check: "<?php if(isset($_GET['role_id'])) { if(in_array('257',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"}
	]},
	...
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view');?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "261", check: "<?php if(isset($_GET['role_id'])) { if(in_array('261',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"}
	]},
	...
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('left_expense');?>",  add_info: "<?php echo $this->lang->line('xin_add_edit_delete_role_info');?>", value: "10", check: "<?php if(isset($_GET['role_id'])) { if(in_array('10',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>",items: [
	...
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_add');?>",  add_info: "<?php echo $this->lang->line('xin_role_add');?>", value: "310", check: "<?php if(isset($_GET['role_id'])) { if(in_array('310',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_edit');?>",  add_info: "<?php echo $this->lang->line('xin_role_add');?>", value: "311", check: "<?php if(isset($_GET['role_id'])) { if(in_array('311',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_delete');?>",  add_info: "<?php echo $this->lang->line('xin_role_add');?>", value: "312", check: "<?php if(isset($_GET['role_id'])) { if(in_array('312',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view');?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "313", check: "<?php if(isset($_GET['role_id'])) { if(in_array('313',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_download');?>",  add_info: "<?php echo $this->lang->line('xin_download');?>", value: "314", check: "<?php if(isset($_GET['role_id'])) { if(in_array('314',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view_own');?>",  add_info: "<?php echo $this->lang->line('xin_role_view_own');?>", value: "389", check: "<?php if(isset($_GET['role_id'])) { if(in_array('389',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"}
	]},
	]}, // sub 1 end
	...
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view');?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "265", check: "<?php if(isset($_GET['role_id'])) { if(in_array('265',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view_own');?>",  add_info: "<?php echo $this->lang->line('xin_role_view_own');?>", value: "374", check: "<?php if(isset($_GET['role_id'])) { if(in_array('374',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"}
	]},
	...
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view');?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "272", check: "<?php if(isset($_GET['role_id'])) { if(in_array('272',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"}
	]},
	...
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view');?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "276", check: "<?php if(isset($_GET['role_id'])) { if(in_array('276',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"}
	]},
	]},

  // timesheet : Luffy 7380
	...
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('left_attendance');?>",  add_info: "<?php echo $this->lang->line('xin_view');?>", value: "", check: "<?php if(isset($_GET['role_id'])) { if(in_array('',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>", items: [
    //luffy
    { id: "", class: "role-checkbox-modal", text: "Enable Module",  add_info: "Enable Module", value: "28", check: "<?php if(isset($_GET['role_id'])) { if(in_array('28',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
    { id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_view');?> All",  add_info: "<?php echo $this->lang->line('xin_view');?>", value: "2087", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2087',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
    { id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_view');?> Own",  add_info: "<?php echo $this->lang->line('xin_view');?>", value: "2088", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2088',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
  ]},
  // Timesheet Approval - Luffy 7380
  { id: "", class: "role-checkbox-modal", text: "Attendance Approval",  add_info: "Edit/View", value: "1017",check: "<?php if(isset($_GET['role_id'])) { if(in_array('1017',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>",items: [
    { id: "", class: "role-checkbox-modal", text: "Enable Module",  add_info: "Enable Module", value: "1017", check: "<?php if(isset($_GET['role_id'])) { if(in_array('1017',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
    { id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_add');?>",  add_info: "<?php echo $this->lang->line('xin_role_add');?>", value: "2075", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2075',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
    { id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_edit');?>",  add_info: "<?php echo $this->lang->line('xin_role_edit');?>", value: "2076", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2076',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
    // { id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_delete');?>",  add_info: "<?php echo $this->lang->line('xin_role_delete');?>", value: "2077", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2077',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
    { id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_view');?> All",  add_info: "<?php echo $this->lang->line('xin_view');?>", value: "2078", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2078',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
    { id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_view');?> Own",  add_info: "<?php echo $this->lang->line('xin_view');?>", value: "2086", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2086',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
  ]},
	...
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view');?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "381", check: "<?php if(isset($_GET['role_id'])) { if(in_array('381',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view_own');?>",  add_info: "<?php echo $this->lang->line('xin_role_view_own');?>", value: "382", check: "<?php if(isset($_GET['role_id'])) { if(in_array('382',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"}
	]},
	...
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view_own');?>",  add_info: "<?php echo $this->lang->line('xin_role_view_own');?>", value: "379", check: "<?php if(isset($_GET['role_id'])) { if(in_array('379',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"}
	]},
	...
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view');?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "286", check: "<?php if(isset($_GET['role_id'])) { if(in_array('286',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"}
	]},
	...
	{ id: "", class: "role-checkbox-modal", text: "View Detail",  add_info: "<?php echo $this->lang->line('xin_role_add');?>", value: "288", check: "<?php if(isset($_GET['role_id'])) { if(in_array('288',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
	...
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view');?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "290", check: "<?php if(isset($_GET['role_id'])) { if(in_array('290',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view_own');?>",  add_info: "<?php echo $this->lang->line('xin_role_view_own');?>", value: "383", check: "<?php if(isset($_GET['role_id'])) { if(in_array('383',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"}
	]},
	]},
	...
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view');?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "301", check: "<?php if(isset($_GET['role_id'])) { if(in_array('301',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"}
	]},
	...
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view');?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "305", check: "<?php if(isset($_GET['role_id'])) { if(in_array('305',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view_own');?>",  add_info: "<?php echo $this->lang->line('xin_role_view_own');?>", value: "380", check: "<?php if(isset($_GET['role_id'])) { if(in_array('380',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"}
	]},
	]},
	...
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view');?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "309", check: "<?php if(isset($_GET['role_id'])) { if(in_array('309',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view_own');?>",  add_info: "<?php echo $this->lang->line('xin_role_view_own');?>", value: "384", check: "<?php if(isset($_GET['role_id'])) { if(in_array('384',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"}
	]},
	...
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view');?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "318", check: "<?php if(isset($_GET['role_id'])) { if(in_array('318',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view_own');?>",  add_info: "<?php echo $this->lang->line('xin_role_view_own');?>", value: "386", check: "<?php if(isset($_GET['role_id'])) { if(in_array('386',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"}
	]},
	...
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view');?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "322", check: "<?php if(isset($_GET['role_id'])) { if(in_array('322',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view_own');?>",  add_info: "<?php echo $this->lang->line('xin_role_view_own');?>", value: "385", check: "<?php if(isset($_GET['role_id'])) { if(in_array('385',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"}
	]},
	...
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view');?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "326", check: "<?php if(isset($_GET['role_id'])) { if(in_array('326',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"}
	]},
	//{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_invoice_create');?>",  add_info: "<?php echo $this->lang->line('xin_view');?>", value: "120", check: "<?php if(isset($_GET['role_id'])) { if(in_array('120',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
	...
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view');?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "330", check: "<?php if(isset($_GET['role_id'])) { if(in_array('330',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"}
	]},
	...
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view');?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "337", check: "<?php if(isset($_GET['role_id'])) { if(in_array('337',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"}
	]},
...
// luffy 10 Feb 2020 01:22 pm | Finance Section
{ id: "", class: "role-checkbox-modal", text: "Finance", check: "<?php if(isset($_GET['role_id'])) { if(in_array('1022',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>", add_info: "<?php echo $this->lang->line('xin_add_edit_view_delete_role_info');?>", value: "1022",items: [
	// Finance Form
	{ id: "", class: "role-checkbox-modal", text: "Finance Form",  add_info: "Add/Edit/View/Delete", value: "1021",check: "<?php if(isset($_GET['role_id'])) { if(in_array('1021',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
	// Accounts List
...
{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('left_training_list');?>", check: "<?php if(isset($_GET['role_id'])) { if(in_array('54',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>", add_info: "<?php echo $this->lang->line('xin_add_edit_view_delete_role_info');?>", value: "54",items: [
	...
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view');?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "344", check: "<?php if(isset($_GET['role_id'])) { if(in_array('344',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view_own');?>",  add_info: "<?php echo $this->lang->line('xin_role_view_own');?>", value: "378", check: "<?php if(isset($_GET['role_id'])) { if(in_array('378',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"}
	]},
...
{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('left_trainers_list');?>", check: "<?php if(isset($_GET['role_id'])) { if(in_array('56',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>", add_info: "<?php echo $this->lang->line('xin_add_edit_delete_role_info');?>", value: "56",items: [
	...
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view');?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "351", check: "<?php if(isset($_GET['role_id'])) { if(in_array('351',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"}
	]},
]},
...
// { id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('hd_changelog');?>",  add_info: "<?php echo $this->lang->line('xin_view');?>", value: "87", check: "<?php if(isset($_GET['role_id'])) { if(in_array('87',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
  ...
  // General Report
  { id: "", class: "role-checkbox-modal", text: "General Report",  add_info: "Add/Edit/View/Delete", value: "1018",check: "<?php if(isset($_GET['role_id'])) { if(in_array('1018',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>",items: [
    { id: "", class: "role-checkbox-modal", text: "Enable Module",  add_info: "Enable Module", value: "1018", check: "<?php if(isset($_GET['role_id'])) { if(in_array('1018',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
    // { id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_add');?>",  add_info: "<?php echo $this->lang->line('xin_role_add');?>", value: "2078", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2078',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
    // { id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_edit');?>",  add_info: "<?php echo $this->lang->line('xin_role_edit');?>", value: "2079", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2079',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
    // { id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_delete');?>",  add_info: "<?php echo $this->lang->line('xin_role_delete');?>", value: "2080", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2080',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
    { id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_view');?>",  add_info: "<?php echo $this->lang->line('xin_view');?>", value: "2081", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2081',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
    { id: "", class: "role-checkbox-modal", text: "View Detail",  add_info: "View Detail", value: "2082", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2082',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
    // { id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view_own');?>",  add_info: "<?php echo $this->lang->line('xin_role_view_own');?>", value: "2083", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2083',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"}
  ]},
	]},
  // luffy start - Appraisal Module
	{ id: "", class: "role-checkbox-modal", text: "Appraisal <small style='color:#f64747;'>[new]</small>",  add_info: "", check: "<?php if(isset($_GET['role_id'])) { if(in_array('1000',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>", value: "1000",  items: [
    // Assign Task
    { id: "", class: "role-checkbox-modal", text: "Assign Task",  add_info: "Add/Edit/View/Delete", value: "1001", check: "<?php if(isset($_GET['role_id'])) { if(in_array('1001',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>",items: [
    	{ id: "", class: "role-checkbox-modal", text: "Enable Module",  add_info: "Enable Module", value: "1001", check: "<?php if(isset($_GET['role_id'])) { if(in_array('1001',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
    	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_add');?>",  add_info: "<?php echo $this->lang->line('xin_role_add');?>", value: "2000", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2000',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
    	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_edit');?>",  add_info: "<?php echo $this->lang->line('xin_role_edit');?>", value: "2001", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2001',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
    	//delete cukup dari main task
      //{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_delete');?>",  add_info: "<?php echo $this->lang->line('xin_role_delete');?>", value: "2002", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2002',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
    	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_view');?>",  add_info: "<?php echo $this->lang->line('xin_view');?>", value: "2003", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2003',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
    	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view_own');?>",  add_info: "<?php echo $this->lang->line('xin_role_view_own');?>", value: "2004", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2004',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"}
  	]},
    // Main Task
  	{ id: "", class: "role-checkbox-modal", text: "Main Task",  add_info: "Add/Edit/View/Delete", value: "1002",check: "<?php if(isset($_GET['role_id'])) { if(in_array('1002',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>",items: [
    	{ id: "", class: "role-checkbox-modal", text: "Enable Module",  add_info: "Enable Module", value: "1002", check: "<?php if(isset($_GET['role_id'])) { if(in_array('1002',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
    	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_add');?>",  add_info: "<?php echo $this->lang->line('xin_role_add');?>", value: "2005", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2005',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
    	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_edit');?>",  add_info: "<?php echo $this->lang->line('xin_role_edit');?>", value: "2006", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2006',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
    	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_delete');?>",  add_info: "<?php echo $this->lang->line('xin_role_delete');?>", value: "2007", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2007',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
    	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_view');?>",  add_info: "<?php echo $this->lang->line('xin_view');?>", value: "2008", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2008',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
      // { id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view_own');?>",  add_info: "<?php echo $this->lang->line('xin_role_view_own');?>", value: "2009", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2009',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"}
    ]},
    // Subtask
  	{ id: "", class: "role-checkbox-modal", text: "Subtask",  add_info: "Add/Edit/View/Delete", value: "1003",check: "<?php if(isset($_GET['role_id'])) { if(in_array('1003',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>",items: [
    	{ id: "", class: "role-checkbox-modal", text: "Enable Module",  add_info: "Enable Module", value: "1003", check: "<?php if(isset($_GET['role_id'])) { if(in_array('1003',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
    	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_add');?>",  add_info: "<?php echo $this->lang->line('xin_role_add');?>", value: "2010", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2010',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
    	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_edit');?>",  add_info: "<?php echo $this->lang->line('xin_role_edit');?>", value: "2011", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2011',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
    	//delete cukup dari main task
      //{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_delete');?>",  add_info: "<?php echo $this->lang->line('xin_role_delete');?>", value: "2012", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2012',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
    	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_view');?>",  add_info: "<?php echo $this->lang->line('xin_view');?>", value: "2013", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2013',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
      { id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view_own');?>",  add_info: "<?php echo $this->lang->line('xin_role_view_own');?>", value: "2014", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2014',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
      { id: "", class: "role-checkbox-modal", text: "Auditor <small>[Valid & Reject]</small>",  add_info: "For Auditor", value: "2084", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2084',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
      { id: "", class: "role-checkbox-modal", text: "Reviewer <small>[Qualified & Reject]</small>",  add_info: "For Review", value: "2085", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2085',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"}
    ]},
    // Rewards list
  	{ id: "", class: "role-checkbox-modal", text: "Rewards List",  add_info: "Add/Edit/View/Delete", value: "1004",check: "<?php if(isset($_GET['role_id'])) { if(in_array('1004',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>",items: [
    	{ id: "", class: "role-checkbox-modal", text: "Enable Module",  add_info: "Enable Module", value: "1004", check: "<?php if(isset($_GET['role_id'])) { if(in_array('1004',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
    	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_add');?>",  add_info: "<?php echo $this->lang->line('xin_role_add');?>", value: "2015", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2015',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
    	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_edit');?>",  add_info: "<?php echo $this->lang->line('xin_role_edit');?>", value: "2016", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2016',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
    	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_delete');?>",  add_info: "<?php echo $this->lang->line('xin_role_delete');?>", value: "2017", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2017',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
    	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_view');?>",  add_info: "<?php echo $this->lang->line('xin_view');?>", value: "2018", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2018',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
      // { id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view_own');?>",  add_info: "<?php echo $this->lang->line('xin_role_view_own');?>", value: "2019", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2019',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"}
    ]},
    // Assign rewards
  	{ id: "", class: "role-checkbox-modal", text: "Assign Rewards",  add_info: "Add/Edit/View/Delete", value: "1008",check: "<?php if(isset($_GET['role_id'])) { if(in_array('1008',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>",items: [
    	{ id: "", class: "role-checkbox-modal", text: "Enable Module",  add_info: "Enable Module", value: "1008", check: "<?php if(isset($_GET['role_id'])) { if(in_array('1008',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
    	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_add');?>",  add_info: "<?php echo $this->lang->line('xin_role_add');?>", value: "2035", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2035',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
    	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_edit');?>",  add_info: "<?php echo $this->lang->line('xin_role_edit');?>", value: "2036", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2036',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
    	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_delete');?>",  add_info: "<?php echo $this->lang->line('xin_role_delete');?>", value: "2037", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2037',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
    	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_view');?>",  add_info: "<?php echo $this->lang->line('xin_view');?>", value: "2038", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2038',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
      { id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view_own');?>",  add_info: "<?php echo $this->lang->line('xin_role_view_own');?>", value: "2039", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2039',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"}
    ]},
    // Punishment list
  	{ id: "", class: "role-checkbox-modal", text: "Punishment List",  add_info: "Add/Edit/View/Delete", value: "1005",check: "<?php if(isset($_GET['role_id'])) { if(in_array('1005',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>",items: [
    	{ id: "", class: "role-checkbox-modal", text: "Enable Module",  add_info: "Enable Module", value: "1005", check: "<?php if(isset($_GET['role_id'])) { if(in_array('1005',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
    	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_add');?>",  add_info: "<?php echo $this->lang->line('xin_role_add');?>", value: "2020", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2020',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
    	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_edit');?>",  add_info: "<?php echo $this->lang->line('xin_role_edit');?>", value: "2021", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2021',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
    	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_delete');?>",  add_info: "<?php echo $this->lang->line('xin_role_delete');?>", value: "2022", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2022',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
    	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_view');?>",  add_info: "<?php echo $this->lang->line('xin_view');?>", value: "2023", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2023',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
      // { id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view_own');?>",  add_info: "<?php echo $this->lang->line('xin_role_view_own');?>", value: "2024", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2024',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"}
    ]},
    // Assign punishment
  	{ id: "", class: "role-checkbox-modal", text: "Assign Punishment",  add_info: "Add/Edit/View/Delete", value: "1009",check: "<?php if(isset($_GET['role_id'])) { if(in_array('1009',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>",items: [
    	{ id: "", class: "role-checkbox-modal", text: "Enable Module",  add_info: "Enable Module", value: "1009", check: "<?php if(isset($_GET['role_id'])) { if(in_array('1009',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
    	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_add');?>",  add_info: "<?php echo $this->lang->line('xin_role_add');?>", value: "2040", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2040',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
    	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_edit');?>",  add_info: "<?php echo $this->lang->line('xin_role_edit');?>", value: "2041", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2041',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
    	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_delete');?>",  add_info: "<?php echo $this->lang->line('xin_role_delete');?>", value: "2042", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2042',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
    	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_view');?>",  add_info: "<?php echo $this->lang->line('xin_view');?>", value: "2043", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2043',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
      { id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view_own');?>",  add_info: "<?php echo $this->lang->line('xin_role_view_own');?>", value: "2044", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2044',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"}
    ]},
    // KPI sales
  	{ id: "", class: "role-checkbox-modal", text: "KPI Sales",  add_info: "Add/Edit/View/Delete", value: "1006",check: "<?php if(isset($_GET['role_id'])) { if(in_array('1006',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>",items: [
    	{ id: "", class: "role-checkbox-modal", text: "Enable Module",  add_info: "Enable Module", value: "1006", check: "<?php if(isset($_GET['role_id'])) { if(in_array('1006',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
    	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_add');?>",  add_info: "<?php echo $this->lang->line('xin_role_add');?>", value: "2025", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2025',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
    	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_edit');?>",  add_info: "<?php echo $this->lang->line('xin_role_edit');?>", value: "2026", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2026',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
    	//delete cukup dari main task
      //{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_delete');?>",  add_info: "<?php echo $this->lang->line('xin_role_delete');?>", value: "2027", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2027',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
    	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_view');?>",  add_info: "<?php echo $this->lang->line('xin_view');?>", value: "2028", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2028',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
      // { id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view_own');?>",  add_info: "<?php echo $this->lang->line('xin_role_view_own');?>", value: "2029", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2029',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"}
    ]},
    // Grade list
  	{ id: "", class: "role-checkbox-modal", text: "Grade List",  add_info: "Add/Edit/View/Delete", value: "1007",check: "<?php if(isset($_GET['role_id'])) { if(in_array('1007',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>",items: [
    	{ id: "", class: "role-checkbox-modal", text: "Enable Module",  add_info: "Enable Module", value: "1007", check: "<?php if(isset($_GET['role_id'])) { if(in_array('1007',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
    	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_add');?>",  add_info: "<?php echo $this->lang->line('xin_role_add');?>", value: "2030", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2030',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
    	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_edit');?>",  add_info: "<?php echo $this->lang->line('xin_role_edit');?>", value: "2031", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2031',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
    	//delete cukup dari main task
      //{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_delete');?>",  add_info: "<?php echo $this->lang->line('xin_role_delete');?>", value: "2032", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2032',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
    	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_view');?>",  add_info: "<?php echo $this->lang->line('xin_view');?>", value: "2033", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2033',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
      // { id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view_own');?>",  add_info: "<?php echo $this->lang->line('xin_role_view_own');?>", value: "2034", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2034',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"}
    ]},
    // Appraisal Report
  	{ id: "", class: "role-checkbox-modal", text: "Appraisal Report",  add_info: "Add/Edit/View/Delete", value: "1010",check: "<?php if(isset($_GET['role_id'])) { if(in_array('1010',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>",items: [
    	{ id: "", class: "role-checkbox-modal", text: "Enable Module",  add_info: "Enable Module", value: "1010", check: "<?php if(isset($_GET['role_id'])) { if(in_array('1010',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
    	// { id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_add');?>",  add_info: "<?php echo $this->lang->line('xin_role_add');?>", value: "2045", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2045',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
    	// { id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_edit');?>",  add_info: "<?php echo $this->lang->line('xin_role_edit');?>", value: "2046", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2046',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
    	// { id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_delete');?>",  add_info: "<?php echo $this->lang->line('xin_role_delete');?>", value: "2047", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2047',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
    	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_view');?>",  add_info: "<?php echo $this->lang->line('xin_view');?>", value: "2048", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2048',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
      { id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view_own');?>",  add_info: "<?php echo $this->lang->line('xin_role_view_own');?>", value: "2049", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2049',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"}
    ]},
	]},
  	// Dayoff module
	...
	// rolling shift ends
//   // Immigrations
//   { id: "", class: "role-checkbox-modal", text: "Immigrations",  add_info: "Add/Edit/View/Delete", value: "1016",check: "<?php if(isset($_GET['role_id'])) { if(in_array('1016',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>",items: [
//     // { id: "", class: "role-checkbox-modal", text: "Enable Module",  add_info: "Enable Module", value: "1016", check: "<?php if(isset($_GET['role_id'])) { if(in_array('1016',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
//     // { id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_add');?>",  add_info: "<?php echo $this->lang->line('xin_role_add');?>", value: "2070", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2070',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
//     { id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_edit');?>",  add_info: "<?php echo $this->lang->line('xin_role_edit');?>", value: "2071", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2071',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
//     { id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_delete');?>",  add_info: "<?php echo $this->lang->line('xin_role_delete');?>", value: "2072", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2072',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
//     { id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_view');?>",  add_info: "<?php echo $this->lang->line('xin_view');?>", value: "2073", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2073',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
//     // { id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_view_own');?>",  add_info: "<?php echo $this->lang->line('xin_role_view_own');?>", value: "2074", check: "<?php if(isset($_GET['role_id'])) { if(in_array('2074',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"}
//   ]},
	//   // Customer data | salah room, yg dimaksud mgkin ini buat A1
	//   // Contacts list, upload from excel.
	//   { id: "", class: "role-checkbox-modal", text: "Customer Data <small style='color:#f64747;'>[new]</small>",  add_info: "", check: "<?php if(isset($_GET['role_id'])) { if(in_array('3000',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>", value: "3000",  items: [
	//     { id: "", class: "role-checkbox-modal", text: "Customer List",  add_info: "", value: "3001", check: "<?php if(isset($_GET['role_id'])) { if(in_array('3001',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
	//     { id: "", class: "role-checkbox-modal", text: "Import Customer",  add_info: "", value: "3002", check: "<?php if(isset($_GET['role_id'])) { if(in_array('3002',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
	//   ]},
  // luffy 10 Feb 2020 11:42 am
  // Company Policy
  { id: "", class: "role-checkbox-modal", text: "Company Policy",  add_info: "Add/Edit/View/Delete", value: "1020",check: "<?php if(isset($_GET['role_id'])) { if(in_array('1020',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
  // luffy end
]
});
