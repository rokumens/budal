...
<div class="box animated fadeInRight">
  <div class="box-header with-border">AMP Data Import.</div>
  <div class="box-body">
    <p class="card-text">Click the button to start importing data from AMP.</p>
    <h6>
      <a href="<?=site_url('admin/appraisal_report/import');?>" class="btn btn-primary importAMP" type="button">
        <span class="txtAMPDone"> Import </span>
        <span class="txtAMPStart" style="display:none;"> <i class="fa fa-spinner fa-spin"></i> Start importing data, please be patience... </span>
      </a>
    </h6>
    <div class="AMPResponse">
    ...
    <div class="box-body">
      <div class="row">
        <div class="col-md-12">
          ...
          <?=form_open('admin/appraisal_report/report_list', $attributes, $hidden);?>
          <?php
  				$data = array(
  				  'type'        => 'hidden',
  				  'name'        => 'date_format',
