    ...
    <div class="form-group">
      ...
      <div class="col-md-6">
        <div class="form-group">
          ...
          <textarea class="form-control textarea" placeholder="<?php echo $this->lang->line('xin_hr_event_note');?>" name="event_note" cols="30" rows="15" id="event_note2"><?php echo $event_note;?></textarea>
        </div>
      </div>
    </div>
  </div>
