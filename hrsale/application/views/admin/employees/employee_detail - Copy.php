          ...
          <div class="card-body">
            <div class="card overflow-hidden">
			  ...
			  ?>
                    ...
                    <div class="tab-pane current-tab <?php echo $get_animate;?>" id="work-experience">
                      <div class="box-header with-border">
			  ...
			  ?>
                    ...
                    <div class="tab-pane current-tab <?php echo $get_animate;?>" id="social-networking">
                      <div class="box-header with-border">
                    ...
                    <div class="tab-pane current-tab <?php echo $get_animate;?>" id="change-password">
                      <div class="box-header with-border">
        ...
        <div class="tab-pane <?php echo $get_animate;?>" id="xin_employee_set_salary">
          <div class="card-body">
            <div class="card overflow-hidden">
              <div class="row no-gutters row-bordered row-border-light">
                <div class="col-md-3 pt-0">
                  <div class="list-group list-group-flush account-settings-links"> <a class="salary-tab-list list-group-item list-group-item-action active salary-tab" data-toggle="list" href="javascript:void(0);" data-profile="1" data-profile-block="salary" aria-expanded="true" id="suser_profile_1"><?php echo $this->lang->line('xin_employee_update_salary');?></a> <a class="salary-tab-list list-group-item list-group-item-action salary-tab" data-toggle="list" href="javascript:void(0);" data-profile="2" data-profile-block="set_allowances" aria-expanded="true" id="suser_profile_2"><?php echo $this->lang->line('xin_employee_set_allowances');?></a> <a class="salary-tab-list list-group-item list-group-item-action salary-tab" data-toggle="list" href="javascript:void(0);" data-profile="3" data-profile-block="loan_deductions" aria-expanded="true" id="suser_profile_3"><?php echo $this->lang->line('xin_employee_set_loan_deductions');?></a> <a class="salary-tab-list list-group-item list-group-item-action salary-tab" data-toggle="list" href="javascript:void(0);" data-profile="4" data-profile-block="statutory_deductions" aria-expanded="true" id="suser_profile_4"><?php echo $this->lang->line('xin_employee_set_statutory_deductions');?></a> <a class="salary-tab-list list-group-item list-group-item-action salary-tab" data-toggle="list" href="javascript:void(0);" data-profile="5" data-profile-block="other_payment" aria-expanded="true" id="suser_profile_5"><?php echo $this->lang->line('xin_employee_set_other_payment');?></a> <a class="salary-tab-list list-group-item list-group-item-action salary-tab" data-toggle="list" href="javascript:void(0);" data-profile="6" data-profile-block="overtime" aria-expanded="true" id="suser_profile_6"><?php echo $this->lang->line('dashboard_overtime');?></a> </div>
                </div>
                <div class="col-md-9">
                        ...
                        <div class="bg-white">
                          <div class="row">
                            ...
                            <div class="col-md-4">
                              ...
                              <div class="form-group">
                                <input class="form-control basic_salary" placeholder="<?php echo $this->lang->line('xin_payroll_basic_salary');?>" name="basic_salary" type="text" value="<?php echo $basic_salary;?>">
                              </div>
                            </div>
                            <div class="col-md-4">
                              <label for="basic_salary"><?php echo $this->lang->line('xin_employee_daily_wages');?></label>
                              <div class="form-group">
                                <input class="form-control daily_wages" placeholder="<?php echo $this->lang->line('xin_employee_daily_wages');?>" name="daily_wages" type="text" value="<?php echo $daily_wages;?>">
                              </div>
                            </div>
                          </div>
                          <div class="form-actions box-footer"> <?php echo form_button(array('name' => 'hrsale_form', 'type' => 'submit', 'class' => $this->Xin_model->form_button_class(), 'content' => '<i class="fa fa fa-check-square-o"></i> '.$this->lang->line('xin_save'))); ?> </div>
			  ...
			  ?>
                    ...
                    <div class="tab-pane <?php echo $get_animate;?> salary-current-tab" id="loan_deductions">
                      <div class="box-header with-border">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input class="form-control" placeholder="<?php echo $this->lang->line('xin_employee_monthly_installment_title');?>" name="monthly_installment" type="number" id="m_monthly_installment">
                            </div>
                          </div>
                        </div>
                        <div class="row">
                    ...
                    <div class="tab-pane <?php echo $get_animate;?> salary-current-tab" id="statutory_deductions">
                      <div class="box-header with-border">
                      ...
                      <div class="box-body pb-2">
                        ...
                        <div class="row">
                          <div class="col-md-4">
                            <div class="form-group">
                              <label for="salary_ssempee"><?php echo $this->lang->line('xin_employee_set_ssempee');?> (%)</label>
                              <input class="form-control" placeholder="<?php echo $this->lang->line('xin_amount');?>" name="salary_ssempee" type="text" value="<?php echo $salary_ssempee;?>" id="salary_ssempee">
                            </div>
                          </div>
                          <div class="col-md-4">
                            <div class="form-group">
                              <label for="salary_ssempeer"><?php echo $this->lang->line('xin_employee_set_ssempeer');?> (%)</label>
                              <input class="form-control" placeholder="<?php echo $this->lang->line('xin_amount');?>" name="salary_ssempeer" type="text" value="<?php echo $salary_ssempeer;?>" id="salary_ssempeer">
                            </div>
                          </div>
                          <div class="col-md-4">
                            <div class="form-group">
                              <label for="salary_income_tax"><?php echo $this->lang->line('xin_employee_set_inc_tax');?> (%)</label>
                              <input class="form-control" placeholder="<?php echo $this->lang->line('xin_amount');?>" name="salary_income_tax" type="text" value="<?php echo $salary_income_tax;?>" id="salary_income_tax">
                            </div>
                          </div>
                        </div>
                        <div class="row">
                    ...
                    <div class="tab-pane <?php echo $get_animate;?> salary-current-tab" id="other_payment">
                      <div class="box-header with-border">
                        ...
                        <div class="row">
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <input class="form-control" placeholder="<?php echo $this->lang->line('xin_amount');?>" name="salary_commission" type="text" value="<?php echo $salary_commission;?>" id="salary_commission">
                            </div>
                          </div>
                          <div class="col-md-4">
                            <div class="form-group">
                              <label for="salary_claims"><?php echo $this->lang->line('xin_employee_set_oth_claims');?></label>
                              <input class="form-control" placeholder="<?php echo $this->lang->line('xin_amount');?>" name="salary_claims" type="text" value="<?php echo $salary_claims;?>" id="salary_claims">
                            </div>
                          </div>
                          <div class="col-md-4">
                            <div class="form-group">
                              <label for="salary_paid_leave"><?php echo $this->lang->line('xin_employee_set_oth_paid_leave');?></label>
                              <input class="form-control" placeholder="<?php echo $this->lang->line('xin_amount');?>" name="salary_paid_leave" type="text" value="<?php echo $salary_paid_leave;?>" id="salary_paid_leave">
                            </div>
                          </div>
                          <div class="col-md-4">
                            <div class="form-group">
                              <label for="salary_director_fees"><?php echo $this->lang->line('xin_employee_set_oth_director_fees');?></label>
                              <input class="form-control" placeholder="<?php echo $this->lang->line('xin_amount');?>" name="salary_director_fees" type="text" value="<?php echo $salary_director_fees;?>" id="salary_director_fees">
                            </div>
                          </div>
                          <div class="col-md-4">
                            <div class="form-group">
                              <label for="salary_advance_paid"><?php echo $this->lang->line('xin_employee_set_oth_ad_paid');?></label>
                              <input class="form-control" placeholder="<?php echo $this->lang->line('xin_amount');?>" name="salary_advance_paid" type="text" value="<?php echo $salary_advance_paid;?>" id="salary_advance_paid">
                            </div>
                          </div>
                        </div>
                        <div class="row">
                    ...
                    <div class="tab-pane <?php echo $get_animate;?> salary-current-tab" id="overtime">
                      <div class="box-header with-border">
