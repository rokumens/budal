...
<div class="box mb-4 <?=$get_animate;?>">
  <div id="accordion">
    <div class="box-header  with-border">
      <h3 class="box-title"><?=$this->lang->line('xin_add_new');?> <?=$this->lang->line('xin_employee');?></h3>
    ...
    <div id="add_form" class="collapse add-form <?=$get_animate;?>" data-parent="#accordion" style="">
      <div class="box-body">
        ...
        <?=form_open_multipart('admin/employees/add_employee', $attributes, $hidden);?>
        <div class="form-body">
          <div class="row">
            <div class="col-md-6">
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input class="form-control" placeholder="<?=$this->lang->line('xin_employee_first_name');?>" name="first_name" type="text" value="">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="last_name" class="control-label"><?=$this->lang->line('xin_employee_last_name');?></label>
                    <input class="form-control" placeholder="<?=$this->lang->line('xin_employee_last_name');?>" name="last_name" type="text" value="">
                  </div>
                </div>
              </div>
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group" id="department_ajax">
                    ...
                    <select class="form-control" name="department_id" data-plugin="select_hrm" data-placeholder="<?=$this->lang->line('xin_employee_department');?>" disabled="disabled">
                      <option value=""></option>
                    </select>
                  </div>
                </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input class="form-control" placeholder="<?=$this->lang->line('dashboard_username');?>" name="username" type="text" value="">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="email" class="control-label"><?=$this->lang->line('dashboard_email');?></label>
                    <input class="form-control employeeEmail" placeholder="<?=$this->lang->line('dashboard_email');?>" name="email" type="text" value="" readonly />
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input class="form-control date_of_birth" readonly placeholder="<?=$this->lang->line('xin_employee_dob');?>" name="date_of_birth" type="text" value="">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="time_of_birth">Time of Birth</label>
                    <!-- <input class="form-control time_of_birth" placeholder="Time of Birth" name="time_of_birth" type="time" value=""> -->
                    <input class="form-control timepicker" placeholder="Time of Birth" readonly name="time_of_birth" type="text" value="">
                  </div>
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input class="form-control employeeId" placeholder="<?=$this->lang->line('dashboard_employee_id');?>" name="employee_id" type="text" minlength='4' maxlength='4' value="">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="date_of_joining" class="control-label"><?=$this->lang->line('xin_employee_doj');?></label>
                    <input class="form-control date_of_joining" readonly placeholder="<?=$this->lang->line('xin_employee_doj');?>" name="date_of_joining" type="text" value="">
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-md-6" id="subdepartment_ajax">
                  <div class="form-group">
                    ...
                    <select class="form-control" name="subdepartment_id" data-plugin="select_hrm" disabled="disabled" data-placeholder="<?=$this->lang->line('xin_employee_department');?>">
                      <option value=""></option>
                    </select>
                  </div>
                </div>
                <div class="col-md-6" id="designation_ajax">
                  <div class="form-group">
                    ...
                    <select class="form-control" name="designation_id" data-plugin="select_hrm" disabled="disabled" data-placeholder="<?=$this->lang->line('xin_designation');?>">
                      <option value=""></option>
                    </select>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <select class="form-control" name="gender" data-plugin="select_hrm" data-placeholder="<?=$this->lang->line('xin_employee_gender');?>">
                      <option value="Male"><?=$this->lang->line('xin_gender_male');?></option>
                      <option value="Female"><?=$this->lang->line('xin_gender_female');?></option>
                    </select>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <select class="form-control" name="office_shift_id" data-plugin="select_hrm" data-placeholder="<?=$this->lang->line('xin_employee_office_shift');?>">
                      ...
                      <option value="<?=$shift->office_shift_id?>"><?=$shift->shift_name?></option>
                      <?php } ?>
                    </select>
                  </div>
                </div>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <select multiple="multiple" class="form-control" name="leave_categories[]" data-plugin="select_hrm" data-placeholder="<?=$this->lang->line('xin_hr_leave_cat');?>">
                      ...
                      <option value="<?=$leave_type->leave_type_id?>"><?=$leave_type->type_name?></option>
                      <?php } ?>
                    </select>
                  </div>
                </div>
                <!-- <div class="col-md-6">
                  <div class="form-group">
                    <label for="xin_employee_password"><?=$this->lang->line('xin_employee_password');?></label>
                    <input class="form-control" placeholder="<?=$this->lang->line('xin_employee_password');?>" name="password" type="text" value="">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="confirm_password" class="control-label"><?=$this->lang->line('xin_employee_cpassword');?></label>
                    <input class="form-control" placeholder="<?=$this->lang->line('xin_employee_cpassword');?>" name="confirm_password" type="text" value="">
                  </div>
                </div> -->
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-md-3">
              <div class="form-group">
                ...
                <input class="form-control" placeholder="<?=$this->lang->line('xin_contact_number');?>" name="contact_no" type="text" value="">
              </div>
            </div>
            <div class="col-md-3">
              <div class="form-group">
                <label for="address"><?=$this->lang->line('xin_employee_address');?></label>
                <input type="text" class="form-control" placeholder="<?=$this->lang->line('xin_employee_address');?>" name="address">
              </div>
            </div>
            <div class="col-md-3">
              <div class="form-group">
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Bazi result description from 'suhu'" name="bazi_desc" />
              </div>
            </div>
          </div>
          <div class="row">
...
<div class="box <?=$get_animate;?>">
  <div class="box-header with-border">
    <h3 class="box-title"> <?=$this->lang->line('xin_list_all');?> <?=$this->lang->line('xin_employees');?> </h3>
    <?php if($userRole==1): #superAdmin?>
    <div class="box-tools pull-right">
      <a class="text-dark" href="<?=site_url('admin/employees/deleted');?>" aria-expanded="false">
