        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input class="form-control" name="amount" type="number" value="<?php echo $amount;?>">
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
    ...
    <div class="row">
      ...
      <div class="col-md-3">
        ...
        <div class="form-group">
          <label for="month_year"><?php echo $this->lang->line('xin_amount');?></label>
          <?php /*luffy fixing type to number*/;?>
          <input disabled="disabled" class="form-control" name="amount" type="number" value="<?php echo $transfer_amount;?>">
        </div>
        <div class="form-group">
