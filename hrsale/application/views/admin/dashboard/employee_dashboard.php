...
<?php #by luffy, liat di bawah. $announcement = $this->Announcement_model->get_new_announcements();?>
...
<?php 	$profile_pic = $user[0]->profile_picture_sso;?>
<?php } else {?>
 ...
 * get all announcment
*/
$currentDepartmentId = $user_info[0]->department_id;
$allDepartmentId= 7;
$announcement = $this->Announcement_model->get_new_announcements_by_department($currentDepartmentId, $allDepartmentId);
...
<div class="box-widget widget-user-2">
    ...
    <div class="widget-user-header">
      <div class="widget-user-image">
        <img src="<?php  echo $profile_pic;?>" alt="" id="user_avatar" class="img-circle ui-w-50 rounded-circle" style='border-radius:10% !important;'>
      </div>
      <h4 class="widget-user-username welcome-hrsale-user">Welcome back, <?php echo $user[0]->username;?>!</h4>
