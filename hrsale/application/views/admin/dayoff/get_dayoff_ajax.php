...
<?php $employees = $this->Dayoff_model->getDayoff($curr_subdept_id, $date)->result_array(); ?>
<?php if(!is_null($employees)): ?>
	<?php foreach($employees as $employeex): ?>
	<a data-date="<?=$date;?>" class="data_dayoff fc-day-grid-event fc-h-event fc-event fc-start fc-end fc-draggable" data-toggle="modal" data-target="#myModalDayoff" data-id="<?=$employeex['user_id'];?>">
...
$(document).ready(function(){
  // var subdept_id = $('.currentSubDept').val();
  // alert(subdept_id);
