...
<div class="login-box animated fadeInDownBig">
  ...
  <div class="login-box-body">
    ...
    <!-- <p class="login-box-msg"><?php echo $this->lang->line('xin_admin_login');?><?php echo $company[0]->company_name;?></p> -->
			<?php if(!empty($current_sso_user)):?>
				<center>
				<img src='<?php echo $sso_photo?>' class='img-circle rounded-circle user_profile_avatar'><br /><br />
			  Hello again <?php echo $sso_displayName?>,<br />
				Your account is not active anymore at our company. <br /><br />Click <a href="<?php echo base_url()?>admin/auth/logout_sso">here</a> to go back.
				</center>
			<?php else:?>

				<?php #start form login;?>
			...
			<?php $login_txt = $this->lang->line('xin_login_username');?>
		    ...
		    <div class="row">
		      <div class="col-xs-8 invisible"> <a href="<?php echo site_url('admin/auth/forgot_password');?>" class="d-block small"><?php echo $this->lang->line('xin_forgot_password_link');?></a> </div>
		    ...
		    <?php echo form_close(); ?>
			<?php #end form login;?>
			  <a href="<?php echo base_url()?>admin/auth/login_sso"><img src="<?php echo base_url()?>uploads/logo/signin/btn-login-with-google.png" width='100%' alt=''/></a>
			<?php endif;?>
    <hr>
