        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="form-group" id="designation_ajax">
              <label for="designation"><?php echo $this->lang->line('xin_promotion_title');?></label>
              <select class="form-control" name="title" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_designation');?>">
                <option value=""></option>
                <?php foreach($designations as $designation) {?>
                <option value="<?php echo $designation->designation_id?>" <?php if($designation->designation_id==$title_id):?> selected="selected" <?php endif;?>><?php echo $designation->designation_name;?></option>
                <?php } ?>
              </select>
            </div>
          </div>
