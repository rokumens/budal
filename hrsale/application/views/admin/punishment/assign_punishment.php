...
<?php if(in_array('2040',$role_resources_ids)) {?>
<div class="box mb-4 <?php echo $get_animate;?>">
  <div id="accordion">
    <div class="box-header with-border">
      <h3 class="box-title">Assign New Punishment</h3>
    ...
    <div id="add_form" class="collapse add-form <?php echo $get_animate;?>" data-parent="#accordion" style="">
      <div class="box-body">
        <?php $attributes = array('name' => 'add_assign_punishment', 'id' => 'xin-form', 'autocomplete' => 'off');?>
        <?php $hidden = array('user_id' => $session['user_id']);?>
        <?php echo form_open('admin/assign_punishment/add_assign_punishment', $attributes, $hidden);?>
        <div class="bg-white">
          <div class="box-block">
            <div class="row">
              <div class="col-md-6">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="form-control punishmentDate" placeholder="<?php echo $this->lang->line('xin_select_date');?>" readonly name="punishment_date" type="text" value="<?php echo date('Y-m-d');?>">
                </div>
                <div class="form-group punishment_ajax">
                  <label for="punishment">Punishment</label>
                  <select name="punishment" class="form-control" data-plugin="select_hrm" data-placeholder="Select punishment" disabled>
                    <option value=""></option>
                  </select>
                </div>
            </div>
...
<div class="box <?php echo $get_animate;?>">
  <div class="box-header with-border">
    <h3 class="box-title"> <?php echo $this->lang->line('xin_list_all');echo $my_title;?> Punishments Summary </h3>
  </div>
  <div class="box-body">
