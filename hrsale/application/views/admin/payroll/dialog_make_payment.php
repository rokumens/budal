...
// Adjustment (-)
$arrAdjustmentMinus = $this->Employees_model->all_adjustment_minus($user_id);
...
$net_salary = $add_salary - $adjustmentMinusAmount;
$net_salary = number_format((float)$net_salary, 2, '.', '');
?>
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
  <h4 class="modal-title" id="edit-modal-data"><strong><?=$this->lang->line('xin_payment_for');?></strong> <?=$p_month;?></h4>
</div>
...
<?=form_open('admin/payroll/add_pay_monthly/', $attributes, $hidden);?>
   <div class="row">
      <div class="col-md-12">
        <div class="form-group">
          ...
          <label for="name"><?=$this->lang->line('xin_payroll_basic_salary');?></label>
          <input type="text" name="gross_salary" class="form-control" value="<?=$basic_salary;?>" readonly>
          <input type="hidden" id="emp_id" value="<?=$user_id?>" name="emp_id">
          <input type="hidden" value="<?=$user_id;?>" name="u_id">
          <input type="hidden" value="<?=$basic_salary;?>" name="basic_salary">
          <input type="hidden" value="<?=$wages_type;?>" name="wages_type">
          <input type="hidden" value="<?=$this->input->get('pay_date');?>" name="pay_date" id="pay_date">
        </div>
      </div>
    </div>
    <!-- <input type="hidden" name="salary_commission" value="<?=$s_acommission;?>">
    <input type="hidden" name="salary_paid_leave" value="<?=$s_paid_leave;?>">
    <input type="hidden" name="salary_director_fees" value="<?=$s_director_fees;?>">
    <input type="hidden" name="salary_advance_paid" value="<?=$s_advance_paid;?>">
    <input type="hidden" name="salary_claims" value="<?=$s_claims;?>">
    <input type="hidden" name="salary_ssempee" value="<?=$s_ssempee;?>">
    <input type="hidden" name="salary_ssempeer" value="<?=$s_ssempeer;?>">
    <input type="hidden" name="salary_income_tax" value="<?=$s_income_tax;?>"> -->
		<!-- <div class="row">
      <div class="col-md-12">
        <div class="form-group">
          <label for="name"><?=$this->lang->line('xin_payroll_total_overtime');?></label>
          <input type="text" name="total_overtime" class="form-control" value="<?=$overtime_amount;?>" readonly>
        </div>
      </div>
    </div> -->
    <!-- <div class="row">
      <div class="col-md-12">
        <div class="form-group">
          <label for="name"><?=$this->lang->line('xin_payroll_total_loan');?></label>
          <input type="text" name="total_loan" class="form-control" value="<?=$loan_de_amount;?>" readonly>
        </div>
      </div>
    </div> -->
		<div class="row">
      <div class="col-md-12">
        <div class="form-group">
          <label for="name">Total Adjustment (+)</label>
          <input type="text" name="total_allowances" class="form-control" value="<?=$allowance_amount;?>" readonly>
        </div>
      </div>
    </div>
		<div class="row">
      <div class="col-md-12">
        <div class="form-group">
          <label for="name">Total Adjustment (-)</label>
          <input type="text" name="total_adjustment_minus" class="form-control" value="<?=$adjustmentMinusAmount;?>" readonly>
        </div>
      </div>
    </div>
    ...
    <!-- ga dipake
      ...
      <div class="col-md-12">
        <div class="form-group">
          <label for="name"><?=$this->lang->line('xin_employee_set_statutory_deductions');?></label>
          <input type="text" name="statutory_deductions" class="form-control" value="<?=$statutory_deductions;?>" readonly>
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-md-12">
        <div class="form-group">
          <label for="name"><?=$this->lang->line('xin_employee_set_other_payment');?></label>
          <input type="text" name="other_payment" class="form-control" value="<?=$all_other_payment;?>" readonly>
        </div>
      </div>
    </div>
		-->
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="form-group">
          <label for="name"><?=$this->lang->line('xin_payroll_net_salary');?></label>
          <input type="text" name="net_salary" class="form-control" value="<?=$net_salary;?>">
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-md-6">
        <div class="form-group">
          <label for="name"><?=$this->lang->line('xin_payroll_payment_amount');?></label>
          <input type="text" name="payment_amount" class="form-control" value="<?=$net_salary;?>" readonly>
        </div>
      </div>
    </div>

    <button type="submit" class="btn btn-primary save"><?=$this->lang->line('xin_pay');?></button>
  <?=form_close(); ?>
</div>
</div>
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					var xin_table = $('#xin_table').dataTable({
						"bDestroy": true,
						"ajax": {
							url : "<?=site_url("admin/payroll/payslip_list") ?>?employee_id=0&company_id=<?=$company_id;?>&month_year=<?=$this->input->get('pay_date');?>",
							type : 'GET'
						},
...
<?php $hidden = array('_method' => 'ADD');?>
<?=form_open('admin/payroll/add_pay_hourly/', $attributes, $hidden);?>
    <div class="row">
      <div class="col-md-12">
        <div class="form-group">
          <label for="name"><?=$this->lang->line('xin_payroll_hourly_rate');?></label>
          <input type="text" name="hourly_rate" class="form-control" value="<?=$hourly_rate;?>" readonly>
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-md-12">
        <div class="form-group">
          <input type="hidden" id="emp_id" name="emp_id" value="<?=$user_id?>">
          <input type="hidden" value="<?=$user_id;?>" name="u_id">
          <input type="hidden" value="<?=$_GET['pay_date'];?>" name="pay_date" id="pay_date">
          <label for="name"><?=$this->lang->line('xin_total_hours_worked');?></label>
          <input type="text" name="total_hours_work" class="form-control" value="<?=$Total;?>" readonly>
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-md-12">
        <div class="form-group">
          ...
          <input type="hidden" name="designation_id" value="<?=$designation_id;?>" />
          <label for="name"><?=$this->lang->line('xin_payroll_payment_amount');?></label>
          <input type="text" name="payment_amount" class="form-control" value="<?=(int)$Total * (int)$hourly_rate;?>" readonly>
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-md-12">
        <div class="form-group">
          <label for="payment_method"><?=$this->lang->line('xin_payment_method');?></label>
          <select name="payment_method" class="select2" data-plugin="select_hrm" data-placeholder="<?=$this->lang->line('xin_choose_payment_method');?>">
            <option value="">&nbsp;</option>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="form-group">
          <label for="name"><?=$this->lang->line('xin_payment_comment');?></label>
