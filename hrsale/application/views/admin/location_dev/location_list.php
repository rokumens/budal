            ...
            <div class="col-md-6">
              <div class="form-group">
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      <label for="dns">DNS</label> <small class="form-text text-muted"> (Tanyakan pada staff IT)</small>
                      <input type="text" class="form-control" name="dns" placeholder="Domain Name System">
                    </div>
                    <div class="form-group">
                      <label for="local_ip">Local IP</label> <small class="form-text text-muted"> (Tanyakan pada staff IT)</small>
                      <input type="text" class="form-control" name="local_ip" placeholder="Local IP">
                      <small class="form-text text-muted">Backup if DNS down</small>
                    </div>
                    <div class="form-group">
                      <label for="location_active">Status</label>
                      <?=form_dropdown('location_active', $dropdown_status, set_value('location_active'), 'class="form-control" data-plugin="select_hrm"');?>
                    </div>
