    ...
    <div class="card-datatable table-responsive">
      <table class="datatables-demo table table-striped table-hover table-bordered" id="xin_table">
        ...
        <tbody>
          ...
          <tr>
            <td>Appraisal</td>
            <td>Evaluate all employees with this flexible appraisal module to boost between the company and employee's performance. <small style='color:#f64747;'>[newly added by 7380]</small></td>
            <td><label class="switcher">
                  <input type="checkbox" class="switcher-input js-switch switch" id="m-appraisal" <?php if($module_appraisal=='true'):?> checked="checked" <?php endif;?> value="true">
                  <span class="switcher-indicator">
                    <span class="switcher-yes"></span>
                    <span class="switcher-no"></span>
                  </span>
          ...
          <tr>
            <td>Day Off</td>
            <td>Day off statistic per sub-department, quota limit by sub-department by daily, and to automatically generate monthly employee's day off. <small style='color:#f64747;'>[newly added by 7380]</small></td>
            <td><label class="switcher">
                  <input type="checkbox" class="switcher-input js-switch switch" id="m-offday" <?php if($module_offday=='true'):?> checked="checked" <?php endif;?> value="true">
                  <span class="switcher-indicator">
                    <span class="switcher-yes"></span>
                    <span class="switcher-no"></span>
                  </span>
          ...
          <tr>
            <td>Immigrations</td>
            <td>It's for immigrrations purpose. <small style='color:#f64747;'>[newly added by 7380]</small></td>
            <td><label class="switcher">
                  <input type="checkbox" class="switcher-input js-switch switch" id="m-immigrations" <?php if($module_immigrations=='true'):?> checked="checked" <?php endif;?> value="true">
                  <span class="switcher-indicator">
                    <span class="switcher-yes"></span>
                    <span class="switcher-no"></span>
                  </span>
