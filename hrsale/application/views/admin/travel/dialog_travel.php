...
<?php $hidden = array('_method' => 'EDIT', '_token' => $travel_id, 'ext_name' => $travel_id);?>
  ...
  <div class="modal-body">
    <div class="row">
      <div class="col-md-6">
        ...
        <input type="hidden" name="company_id" value="<?php foreach($get_all_companies as $company) {?><?php if($company->company_id==$company_id): echo $company->company_id;endif;?><?php } ?>">
        <input type="hidden" name="employee_id" value="<?php foreach($result as $employee) {?><?php if($employee->user_id==$employee_id): echo $employee->user_id;endif;?><?php } ?>">
        <?php } ?>
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
