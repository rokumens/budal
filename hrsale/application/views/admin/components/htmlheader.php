...
<head>
  ...
  <!-- <meta http-equiv="REFRESH" content="60;URL=http://a2.kanonhost.com/admin/timesheet/getdatafingerprint"> -->
  <title><?php echo $title;?></title>
  <!-- Tell the browser to be responsive to screen width -->
  <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">

  <!-- <script src="https://apis.google.com/js/platform.js" async defer></script>
  <meta name="google-signin-client_id" content="801909699912-k2sen8mf0p1lojeujabqt8mfrm224det.apps.googleusercontent.com"> -->
  ...
  <?php } ?>
  <?php if($this->router->fetch_class() =='calendar' || $this->router->fetch_class() =='dashboard' || $this->router->fetch_class() =='dayoff' || $this->router->fetch_class() =='rollingshift'){?>
