...
$(document).ready(function(){
	...
	$('#calendar_hr').fullCalendar({
		...
		events: [
			...
			<?php if(!is_null($lvUser)):?><?php $fName = $lvUser[0]->employee_id. ' - '.$lvUser[0]->username;?>
			...
			<?php else:?><?php echo $leaveType='';?><?php endif;?>
			{
				...
				title: '<?php echo $fName. ' | Leave Request - '.$leaveType;?>',
			...
			{
				title: '<?php echo $upc_birthday->employee_id.' - '.$upc_birthday->username?> | <?php echo $this->lang->line('xin_hr_calendar_upc_birthday');?>',
...
<div id="module-opt" class="fc-popover fc-more-popover" style="display:none; z-index: 100;">
  ...
  <div class="fc-body fc-widget-content" style=" overflow: auto; height: 250px;">
    ...
    <?php if(in_array('8',$role_resources_ids)) { ?><a data-toggle="modal" data-target=".view-modal-data" data-record="0" class="fc-day-grid-event fc-h-event fc-event fc-start fc-end  fc-draggable">
      <div class="fc-content"> <span class="fc-title"><?php echo $this->lang->line('left_holidays');?></span></div>
      </a><?php } ?>
      <?php if(in_array('46',$role_resources_ids)) { ?><a data-toggle="modal" data-target=".view-modal-data" data-record="1" class="fc-day-grid-event fc-h-event fc-event fc-start fc-end  fc-draggable">
      <div class="fc-content"> <span class="fc-title"><?php echo $this->lang->line('left_leave');?></span></div>
      </a><?php } ?>
      <?php if($system[0]->module_travel=='true'){?>
      <?php if(in_array('17',$role_resources_ids)) { ?><a data-toggle="modal" data-target=".view-modal-data" data-record="2" class="fc-day-grid-event fc-h-event fc-event fc-start fc-end  fc-draggable">
      <div class="fc-content"> <span class="fc-title"><?php echo $this->lang->line('xin_travel');?></span></div>
      </a><?php } ?><?php } ?>
      <?php if($system[0]->module_training=='true'){?>
      <?php if(in_array('53',$role_resources_ids)) { ?><a data-toggle="modal" data-target=".view-modal-data" data-record="3" class="fc-day-grid-event fc-h-event fc-event fc-start fc-end  fc-draggable">
      <div class="fc-content"> <span class="fc-title"><?php echo $this->lang->line('xin_hr_calendar_tranings');?></span></div>
      </a><?php } ?><?php } ?>
      <?php if($system[0]->module_projects_tasks=='true'){?>
      <?php if(in_array('44',$role_resources_ids)) { ?><a data-toggle="modal" data-target=".view-modal-data" data-record="4" class="fc-day-grid-event fc-h-event fc-event fc-start fc-end  fc-draggable">
      <div class="fc-content"> <span class="fc-title"><?php echo $this->lang->line('left_projects');?></span></div>
      </a><?php } ?>
      <?php if(in_array('45',$role_resources_ids)) { ?><a data-toggle="modal" data-target=".view-modal-data" data-record="5" class="fc-day-grid-event fc-h-event fc-event fc-start fc-end  fc-draggable">
      <div class="fc-content"> <span class="fc-title"><?php echo $this->lang->line('left_tasks');?></span></div>
      </a><?php } ?><?php } ?>
      <?php if($system[0]->module_events=='true'){?>
       <?php if(in_array('98',$role_resources_ids)) { ?><a data-toggle="modal" data-target=".view-modal-data" data-record="6" class="fc-day-grid-event fc-h-event fc-event fc-start fc-end  fc-draggable">
      <div class="fc-content"> <span class="fc-title"><?php echo $this->lang->line('xin_hr_events');?></span></div>
      </a><?php } ?>
      <?php if(in_array('99',$role_resources_ids)) { ?><a data-toggle="modal" data-target=".view-modal-data" data-record="7" class="fc-day-grid-event fc-h-event fc-event fc-start fc-end  fc-draggable">
