...
<?php //ini buat tombol export Excel di /admin/customer;?>
<script src="https://cdn.datatables.net/buttons/1.2.4/js/dataTables.buttons.min.js"></script>
<script src="https://cdn.datatables.net/buttons/1.2.4/js/buttons.bootstrap.js"></script>
<script src="https://cdn.datatables.net/buttons/1.2.4/js/buttons.html5.js"></script>
<?php //print di bawah untuk fixing ajax bugs "Uncaught Unknown button type: print" - Biar "UPDATE" di dialog ngga bermasalah;?>
...
$(document).ready(function(){
	...
	$('.dateImport').datepicker({
		...
		changeYear: true,
		dateFormat:'dd-mm-yy',
		yearRange: '2013:' + (new Date().getFullYear() + 15),
		beforeShow: function(input) {
			$(input).datepicker("widget").show();
		}
	});
...
<?php #luffy input mask: jquery.mask.min.js ?>
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery.mask/1.13.4/jquery.mask.min.js"></script>
<script src="<?php echo base_url();?>skin/hrsale_assets/hrsale_scripts/custom.js"></script>
<?php if($this->router->fetch_class() =='roles'||$this->router->fetch_class() =='roles_dev') { ?>
...
<script type="text/javascript">
// luffy
// err di project manager, Uncaught SyntaxError: Invalid or unexpected token
// $(document).ready(function(){
...
<?php if($this->router->fetch_class() =='calendar' || $this->router->fetch_class() =='dashboard'){?>
    ...
    <script src="<?php echo base_url();?>skin/hrsale_assets/hrsale_scripts/xchart/employee_status.js" type="text/javascript"></script>
    <script type="text/javascript">
	$(function () {
	/* jQueryKnob */
    $(".knob").knob({
...
<?php }elseif($this->router->fetch_class() =='dayoff'){?>
	<script src="<?php echo base_url();?>skin/hrsale_assets/theme_assets/bower_components/moment/moment.js"></script>
	<script src="<?php echo base_url();?>skin/hrsale_assets/theme_assets/bower_components/fullcalendar/dist/fullcalendar.min.js"></script>
	<?php $this->load->view('admin/dayoff/dayoff_calendar');?>
<?php }elseif($this->router->fetch_class() =='rollingshift'){?>
	<script src="<?php echo base_url();?>skin/hrsale_assets/theme_assets/bower_components/moment/moment.js"></script>
	<script src="<?php echo base_url();?>skin/hrsale_assets/theme_assets/bower_components/fullcalendar/dist/fullcalendar.min.js"></script>
	<?php $this->load->view('admin/rollingshift/rollingshift_calendar');?>
<?php }?>
