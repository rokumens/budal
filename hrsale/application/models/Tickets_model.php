...
class Tickets_model extends CI_Model {
  ...
  // luffy start
	public function get_employee_tickets($employeeId, $deptId, $subDeptId) {
    // $sql = 'SELECT * FROM xin_support_tickets WHERE employee_id = ?';
    $sql = 'SELECT * FROM xin_support_tickets WHERE employee_id = ? OR department_id= ? OR sub_department_id= ?';
    $binds = array($employeeId, $deptId, $subDeptId);
		$query = $this->db->query($sql, $binds);
		return $query;
	}

  // luffy start by assigned to
  ...
  // update assigned to
  public function update_record_assigned_to($data, $id){
