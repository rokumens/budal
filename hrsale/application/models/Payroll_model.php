<?php
	...
	// luffy 4 december 2019 - 02:50 pm
	// to save adjustment minus details
	// used when to "make payment" in general payslip
	public function add_salary_payslip_adjustment_minus($data){
		$this->db->insert('xin_salary_payslip_adjustment_minus', $data);
		if ($this->db->affected_rows() > 0) {
			return true;
		} else {
			return false;
	...
	public function read_payslip_info_adjustment_minus($id) {
