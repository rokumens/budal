<?php
 /**
 * get data from http://finance.form.hrdmanage.com
 *
 * @author luffy
 */
defined('BASEPATH') OR exit('No direct script access allowed');

class Financeform extends MY_Controller {
	...
	{
		$data['title'] = $this->Xin_model->site_title().' | Form from hrd manage';
		...
		// nembak
		// $handle = curl_init('https://webhook.site/fa5b1a90-8044-4cd0-aeb7-61a355fb3fc1');
		// $data = [
		//     'key' => 'value'
		// ];
		...
		// $ch = curl_init();
		// curl_setopt($ch, CURLOPT_URL, "http://finance.form.hrdmanage.com/view.php?id=38780");
		...
		//   echo "Only GET requests allowed\n";
		//   exit();
		// }
		//
		// echo 'post:<br />'; print_r($_POST); echo '<br /><br />';
		// echo 'get:<br />'; print_r($_GET); echo '<br /><br />';
		// echo 'request:<br />'; print_r($_REQUEST); echo '<br /><br />';
		// // die;
		// $fullGetData = $_GET['FormID'];
		//
		// if ($fullGetData == '') {
		//   header('HTTP/1.0 400 Bad request');
		//   echo "No data received from http://finance.form.hrdmanage.com/view.php?id=38780 \n";
		//   exit();
		// }
		// $data = json_decode($fullGetData, true);
		// if ($data === null) {
		//   header('HTTP/1.0 400 Bad request');
