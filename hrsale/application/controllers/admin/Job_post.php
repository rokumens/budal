...
class Job_post extends MY_Controller {
  ...
  public function job_list(){
    ...
    foreach($jobs->result() as $r) {
		...
		if(in_array('292',$role_resources_ids))  // update
