...
class Roles_dev extends MY_Controller {
	...
	public function read(){
		...
		if($roleIdCurrent==3){ // role User
			$roleArr = $this->Roles_model->read_role_information(3);
			$result=$roleArr;
		...
		}elseif($roleIdCurrent==2){ // role Supervisor
			$roleUserArr = $this->Roles_model->read_role_information(3);
			$roleSupervisorArr = $this->Roles_model->read_role_information(2);
		...
		}elseif($roleIdCurrent==1){ // role Manager
			$roleUserArr = $this->Roles_model->read_role_information(3);
			$roleSupervisorArr = $this->Roles_model->read_role_information(2);
			$roleManagerArr = $this->Roles_model->read_role_information(1);
