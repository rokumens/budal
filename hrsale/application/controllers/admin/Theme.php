...
class Theme extends MY_Controller
{
	...
	public function __construct()
  {
	...
	public function index() {
		...
		//	'statistics_cards_background' => $theme_info[0]->statistics_cards_background,
		//	'employee_cards' => $theme_info[0]->employee_cards,
			//'card_border_color' => $theme_info[0]->card_border_color,
		...
		//	'bordered_menu' => $theme_info[0]->bordered_menu,
			...
			//'semi_dark_color' => $theme_info[0]->semi_dark_color,
			//'top_nav_dark_color' => $theme_info[0]->top_nav_dark_color,
		//	'menu_color_option' => $theme_info[0]->menu_color_option,
