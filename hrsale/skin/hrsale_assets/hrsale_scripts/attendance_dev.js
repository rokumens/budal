$(document).ready(function() {
	...
	var xin_table = $('#xin_table').dataTable({
		"bDestroy": true,
		"ajax": {
			url : site_url+"timesheet_dev/attendance_list/?attendance_date="+$('#attendance_date').val()+'&attendance_to_date='+$('#attendance_to_date').val(),
			type : 'GET',
	...
	var xin_table = $('#xin_table_attendance_approval').dataTable({
		"bDestroy": true,
		"ajax": {
			url : site_url+"timesheet_dev/attendance_approval_list",
			type : 'GET',
			error: function(xhr, textStatus, error) {
					// console.log('Error Berat: ' + xhr.responseText);  // luffy
					// console.log('Error Berat: ' + xhr.statusText); // luffy
	...
	$('.view-modal-data').on('show.bs.modal', function (event) {
		...
		var modal = $(this);
	$.ajax({
		url :  site_url+"timesheet_dev/read_map_info/",
		type: "GET",
