$(document).ready(function() {
	...
	// luffy 31 Dec 2019 10:28 am
	// showing all approver list.
	var xin_table_approver = $('#xin_table_approver').dataTable({
		"bDestroy": true,
		"bFilter": false,
		"bLengthChange": false,
		"iDisplayLength": 5,
		"aLengthMenu": [[5, 10, 30, 50, 100, -1], [5, 10, 30, 50, 100, "All"]],
		"ajax": {
      url : site_url+"settings/approval_list/",
      type : 'GET',
	...
	e.preventDefault();
		...
		jQuery('.btn').prop('disabled', true); // luffy 14 January 2020 03:26 pm
		$('.icon-spinner3').show();
		jQuery.ajax({
			type: "POST",
			url: e.target.action,
			...
			success: function (JSON) {
				if(JSON.error != '') {
					...
					$('input[name="csrf_hrsale"]').val(JSON.csrf_hash);
					$('.icon-spinner3').hide();
					// luffy 14 January 2020 03:26 pm
					...
					// luffy 14 January 2020 03:26 pm	
					// clear all fields
					$('#document_type_info')[0].reset(); // To reset form fields
	...
	jQuery("#contract_type_info").submit(function(e){
		e.preventDefault();
		var obj = jQuery(this), action = obj.attr('name');
		jQuery('.btn').prop('disabled', true); // luffy 14 January 2020 13:12
		$('.icon-spinner3').show();
		jQuery.ajax({
			type: "POST",
			url: e.target.action,
			...
			success: function (JSON) {
				if(JSON.error != '') {
					...
					// luffy 14 January 2020 13:12	
					// clear all fields
					$('#contract_type_info')[0].reset(); // luffy: reset form contract type
					$(':input').not(':button, :submit, :reset, :hidden, :checkbox, :radio').val('');
					$(':checkbox, :radio').prop('checked', false);
					$('#description').trumbowyg('empty');
					$('.select2-hidden-accessible').val(null).trigger('change');
	...
	e.preventDefault();
		var obj = jQuery(this), action = obj.attr('name');
		jQuery('.btn').prop('disabled', true); // luffy 14 January 2020 08:09 pm 
		$('.icon-spinner3').show();
		jQuery.ajax({
			type: "POST",
			url: e.target.action,
			...
			success: function (JSON) {
				if(JSON.error != '') {
					toastr.error(JSON.error);
					$('input[name="csrf_hrsale"]').val(JSON.csrf_hash);
					// luffy 14 January 2020 08:09 pm
					jQuery('.btn').prop('disabled', true);
					jQuery('.btn').prop('disabled', false);
					$('.icon-spinner3').hide();
				}else{
	...
	jQuery("#edu_level_info").submit(function(e){
		e.preventDefault();
		var obj = jQuery(this), action = obj.attr('name');
		jQuery('.btn').prop('disabled', true); // luffy 14 January 2020 02:00 pm
		$('.icon-spinner3').show();
		jQuery.ajax({
			type: "POST",
			url: e.target.action,
			...
			success: function (JSON) {
				if(JSON.error != '') {
					toastr.error(JSON.error);
					$('input[name="csrf_hrsale"]').val(JSON.csrf_hash);
					// luffy 14 January 2020 02:00 pm	
					jQuery('.btn').prop('disabled', true);
					jQuery('.btn').prop('disabled', false);
					$('.icon-spinner3').hide();
				}else{
					...
					// luffy 14 January 2020 02:00 pm
					// clear all fields
					$('#edu_level_info')[0].reset(); // reset form eduction
					$(':input').not(':button, :submit, :reset, :hidden, :checkbox, :radio').val('');
					$(':checkbox, :radio').prop('checked', false);
					$('#description').trumbowyg('empty');
					$('.select2-hidden-accessible').val(null).trigger('change');
	...
	jQuery("#edu_language_info").submit(function(e){
		e.preventDefault();
		var obj = jQuery(this), action = obj.attr('name');
		jQuery('.btn').prop('disabled', true); // luffy 14 January 2020 02:03 pm
		$('.icon-spinner3').show();
		jQuery.ajax({
			type: "POST",
			url: e.target.action,
			...
			success: function (JSON) {
				if(JSON.error != '') {
					toastr.error(JSON.error);
					$('input[name="csrf_hrsale"]').val(JSON.csrf_hash);
					// luffy 14 January 2020 02:03 pm
					jQuery('.btn').prop('disabled', true);
					jQuery('.btn').prop('disabled', false);
					$('.icon-spinner3').hide();
				}else{
					...
					// luffy 14 January 2020 02:03 pm	
					// clear all fields
					$('#edu_language_info')[0].reset(); // To reset form fields
					$(':input').not(':button, :submit, :reset, :hidden, :checkbox, :radio').val('');
					$(':checkbox, :radio').prop('checked', false);
					$('#description').trumbowyg('empty');
					$('.select2-hidden-accessible').val(null).trigger('change');
	...
	jQuery("#edu_skill_info").submit(function(e){
		e.preventDefault();
		var obj = jQuery(this), action = obj.attr('name');
		jQuery('.btn').prop('disabled', true); // luffy 14 January 2020 02:11 pm
		$('.icon-spinner3').show();
		jQuery.ajax({
			type: "POST",
			url: e.target.action,
			...
			success: function (JSON) {
				if(JSON.error != '') {
					toastr.error(JSON.error);
					$('input[name="csrf_hrsale"]').val(JSON.csrf_hash);
					// luffy 14 January 2020 02:11 pm
					jQuery('.btn').prop('disabled', true);
					jQuery('.btn').prop('disabled', false);
					$('.icon-spinner3').hide();
				}else{
					...
					// luffy 14 January 2020 02:11 pm
					// clear all fields
					$('#edu_skill_info')[0].reset(); // To reset form fields
					$(':input').not(':button, :submit, :reset, :hidden, :checkbox, :radio').val('');
					$(':checkbox, :radio').prop('checked', false);
					$('#description').trumbowyg('empty');
					$('.select2-hidden-accessible').val(null).trigger('change');
	...
	jQuery("#leave_type_info").submit(function(e){
		e.preventDefault();
		var obj = jQuery(this), action = obj.attr('name');
		jQuery('.btn').prop('disabled', true); // luffy 14 January 2020 03:48 pm
		$('.icon-spinner3').show();
		jQuery.ajax({
			type: "POST",
			url: e.target.action,
			...
			success: function (JSON) {
				if(JSON.error != '') {
					toastr.error(JSON.error);
					$('input[name="csrf_hrsale"]').val(JSON.csrf_hash);
					// luffy 14 January 2020 03:48 pm
					jQuery('.btn').prop('disabled', true);
					jQuery('.btn').prop('disabled', false);
					$('.icon-spinner3').hide();
				}else{
					...
					// luffy 14 January 2020 03:48 pm
					// clear all fields
					$('#leave_type_info')[0].reset(); // To reset form fields
					$(':input').not(':button, :submit, :reset, :hidden, :checkbox, :radio').val('');
					$(':checkbox, :radio').prop('checked', false);
					$('#description').trumbowyg('empty');
					$('.select2-hidden-accessible').val(null).trigger('change');
	...
	jQuery("#travel_arr_type_info").submit(function(e){
		e.preventDefault();
		var obj = jQuery(this), action = obj.attr('name');
		jQuery('.btn').prop('disabled', true); // luffy 14 January 2020 07:59 pm
		$('.icon-spinner3').show();
		jQuery.ajax({
			type: "POST",
			url: e.target.action,
			...
			success: function (JSON) {
				if(JSON.error != '') {
					toastr.error(JSON.error);
					$('input[name="csrf_hrsale"]').val(JSON.csrf_hash);
					// luffy 14 January 2020 07:59 pm
					jQuery('.btn').prop('disabled', true);
					jQuery('.btn').prop('disabled', false);
					$('.icon-spinner3').hide();
				}else{
	...
	jQuery("#award_type_info").submit(function(e){
		e.preventDefault();
		var obj = jQuery(this), action = obj.attr('name');
		jQuery('.btn').prop('disabled', true); // luffy 14 January 2020 03:36 pm
		$('.icon-spinner3').show();
		jQuery.ajax({
			type: "POST",
			url: e.target.action,
			...
			success: function (JSON) {
				if(JSON.error != '') {
					...
					$('input[name="csrf_hrsale"]').val(JSON.csrf_hash);
					$('.icon-spinner3').hide();
					// luffy 14 January 2020 03:36 pm
					jQuery('.btn').prop('disabled', false);
					jQuery('.btn').prop('disabled', false);
				}else{
					...
					// luffy 14 January 2020 03:36 pm
					// clear all fields
					$('#award_type_info')[0].reset(); // To reset form fields
					$(':input').not(':button, :submit, :reset, :hidden, :checkbox, :radio').val('');
					$(':checkbox, :radio').prop('checked', false);
					$('#description').trumbowyg('empty');
					$('.select2-hidden-accessible').val(null).trigger('change');
	...
	jQuery("#warning_type_info").submit(function(e){
		e.preventDefault();
		var obj = jQuery(this), action = obj.attr('name');
		jQuery('.btn').prop('disabled', true); // luffy 14 January 2020 03:58 pm
		$('.icon-spinner3').show();
		jQuery.ajax({
			type: "POST",
			url: e.target.action,
			...
			success: function (JSON) {
				if(JSON.error != '') {
					...
					$('input[name="csrf_hrsale"]').val(JSON.csrf_hash);
					$('.icon-spinner3').hide();
					// luffy 14 January 2020 03:58 pm
					jQuery('.btn').prop('disabled', true);
					jQuery('.btn').prop('disabled', false);
				}else{
					...
					// luffy 14 January 2020 03:58 pm
					// clear all fields
					$('#warning_type_info')[0].reset(); // To reset form fields
					$(':input').not(':button, :submit, :reset, :hidden, :checkbox, :radio').val('');
					$(':checkbox, :radio').prop('checked', false);
					$('#description').trumbowyg('empty');
					$('.select2-hidden-accessible').val(null).trigger('change');
	...
	// luffy 29 December 2019 09:15 pm
	// adding new approver in Approval List section.
	jQuery("#add_approver").submit(function(e){
		e.preventDefault();
		var obj = jQuery(this), action = obj.attr('name');
		jQuery('.save').prop('disabled', true);
		$('.icon-spinner3').show();
		// luffy 31 December 2019 01:06 pm
		$('.btn').prop('disabled', true);
		jQuery.ajax({
			type: "POST",
			url: e.target.action,
			data: obj.serialize()+"&is_ajax=29&data=add_approver&type=add_approver&form="+action,
			cache: false,
			success: function (JSON) {
				if(JSON.error != '') {
					toastr.error(JSON.error);
					...
					xin_table_approver.api().ajax.reload(function(){
						toastr.success(JSON.result);
					}, true);
					$('.icon-spinner3').hide();
					$('input[name="csrf_hrsale"]').val(JSON.csrf_hash);
					$('.btn').prop('disabled', false);
					// luffy 31 December 2019 01:11 pm
					// clear all fields
					$('#add_approver')[0].reset(); // To reset form fields
					$(':input').not(':button, :submit, :reset, :hidden, :checkbox, :radio').val('');
					$(':checkbox, :radio').prop('checked', false);
					$('#description').trumbowyg('empty');
					$('.select2-hidden-accessible').val(null).trigger('change');
	...
	jQuery("#termination_type_info").submit(function(e){
		e.preventDefault();
		var obj = jQuery(this), action = obj.attr('name');
		jQuery('.btn').prop('disabled', true); // luffy 14 January 2020 04:05 pm
		$('.icon-spinner3').show();
		jQuery.ajax({
			type: "POST",
			url: e.target.action,
			...
			success: function (JSON) {
				if(JSON.error != '') {
					...
					$('input[name="csrf_hrsale"]').val(JSON.csrf_hash);
					$('.icon-spinner3').hide();
					// luffy 14 January 2020 04:05 pm
					jQuery('.btn').prop('disabled', true);
					jQuery('.btn').prop('disabled', false);
				}else{
					...
					// luffy 14 January 2020 04:05 pm
					// clear all fields
					$('#termination_type_info')[0].reset(); // To reset form fields
					$(':input').not(':button, :submit, :reset, :hidden, :checkbox, :radio').val('');
					$(':checkbox, :radio').prop('checked', false);
					$('#description').trumbowyg('empty');
					$('.select2-hidden-accessible').val(null).trigger('change');
			...
			// luffy 14 January 2020 04:08 pm
			error: function (xhr, textStatus, error) {
				// console.log('Error Berat: ' + xhr.responseText);  // luffy
				// console.log('Error Berat: ' + xhr.statusText); // luffy
				// console.log('Error Berat: ' + textStatus); // luffy
	...
	jQuery("#expense_type_info").submit(function(e){
		e.preventDefault();
		var obj = jQuery(this), action = obj.attr('name');
		jQuery('.btn').prop('disabled', true); // luffy 14 January 2020 04:17 pm
		$('.icon-spinner3').show();
		jQuery.ajax({
			type: "POST",
			url: e.target.action,
			...
			success: function (JSON) {
				if(JSON.error != '') {
					...
					$('input[name="csrf_hrsale"]').val(JSON.csrf_hash);
					$('.icon-spinner3').hide();
					// luffy 14 January 2020 04:17 pm
					jQuery('.btn').prop('disabled', true);
					jQuery('.btn').prop('disabled', false);
				}else{
					...
					// luffy 14 January 2020 04:17 pm
					// clear all fields
					$('#expense_type_info')[0].reset(); // To reset form fields
					$(':input').not(':button, :submit, :reset, :hidden, :checkbox, :radio').val('');
					$(':checkbox, :radio').prop('checked', false);
					$('#description').trumbowyg('empty');
					$('.select2-hidden-accessible').val(null).trigger('change');
	...
	jQuery("#job_type_info").submit(function(e){
		e.preventDefault();
		var obj = jQuery(this), action = obj.attr('name');
		jQuery('.btn').prop('disabled', true); // luffy 14 January 2020 05:45 pm
		$('.icon-spinner3').show();
		jQuery.ajax({
			type: "POST",
			url: e.target.action,
			...
			success: function (JSON) {
				if(JSON.error != '') {
					...
					$('input[name="csrf_hrsale"]').val(JSON.csrf_hash);
					$('.icon-spinner3').hide();
					// luffy 14 January 2020 05:45 pm
					jQuery('.btn').prop('disabled', true);
					jQuery('.btn').prop('disabled', false);
				}else{
					...
					// luffy 14 January 2020 05:45 pm
					// clear all fields
					$('#job_type_info')[0].reset(); // To reset form fields
					$(':input').not(':button, :submit, :reset, :hidden, :checkbox, :radio').val('');
					$(':checkbox, :radio').prop('checked', false);
					$('#description').trumbowyg('empty');
					$('.select2-hidden-accessible').val(null).trigger('change');
	...
	jQuery("#exit_type_info").submit(function(e){
		e.preventDefault();
		var obj = jQuery(this), action = obj.attr('name');
		jQuery('.btn').prop('disabled', true); // luffy 14 January 2020 05:50 pm
		$('.icon-spinner3').show();
		jQuery.ajax({
			type: "POST",
			url: e.target.action,
			...
			success: function (JSON) {
				if(JSON.error != '') {
					...
					$('input[name="csrf_hrsale"]').val(JSON.csrf_hash);
					$('.icon-spinner3').hide();
					// luffy 14 January 2020 05:50 pm
					jQuery('.btn').prop('disabled', true);
					jQuery('.btn').prop('disabled', false);
				}else{
					...
					// luffy 14 January 2020 05:50 pm
					// clear all fields
					$('#exit_type_info')[0].reset(); // To reset form fields
					$(':input').not(':button, :submit, :reset, :hidden, :checkbox, :radio').val('');
					$(':checkbox, :radio').prop('checked', false);
					$('#description').trumbowyg('empty');
					$('.select2-hidden-accessible').val(null).trigger('change');
	...
	jQuery("#currency_type_info").submit(function(e){
		e.preventDefault();
		var obj = jQuery(this), action = obj.attr('name');
		jQuery('.btn').prop('disabled', true);	// luffy 14 January 2020 08:17 pm
		$('.icon-spinner3').show();
		jQuery.ajax({
			type: "POST",
			url: e.target.action,
			...
			success: function (JSON) {
				if(JSON.error != '') {
					...
					$('input[name="csrf_hrsale"]').val(JSON.csrf_hash);
					$('.icon-spinner3').hide();
					// luffy 14 January 2020 08:17 pm
					jQuery('.btn').prop('disabled', true);
					jQuery('.btn').prop('disabled', false);
				}else{
			...
			// luffy 14 January 2020 08:19 pm
			error: function (xhr, textStatus, error) {
				// console.log('Error Berat: ' + xhr.responseText);  // luffy
				// console.log('Error Berat: ' + xhr.statusText); // luffy
				// console.log('Error Berat: ' + textStatus); // luffy
	...
	jQuery("#company_type_info").submit(function(e){
		e.preventDefault();
		var obj = jQuery(this), action = obj.attr('name');
		jQuery('.btn').prop('disabled', true);	// luffy 14 January 2020 08:20 pm
		$('.icon-spinner3').show();
		jQuery.ajax({
			type: "POST",
			url: e.target.action,
			...
			success: function (JSON) {
				if(JSON.error != '') {
					...
					$('input[name="csrf_hrsale"]').val(JSON.csrf_hash);
					$('.icon-spinner3').hide();
					// luffy 14 January 2020 08:20 pm	
					jQuery('.btn').prop('disabled', true);
					jQuery('.btn').prop('disabled', false);
				}else{
			...
			// luffy 14 January 2020 08:21 pm
			error: function (xhr, textStatus, error) {
				// console.log('Error Berat: ' + xhr.responseText);  // luffy
				// console.log('Error Berat: ' + xhr.statusText); // luffy
				// console.log('Error Berat: ' + textStatus); // luffy
	...
	// luffy: for approval status.
	jQuery("#approval_status").submit(function(e){
		e.preventDefault();
		var obj = jQuery(this), action = obj.attr('name');
		jQuery('.save').prop('disabled', true);
		$('.icon-spinner3').show();
		jQuery.ajax({
			type: "POST",
			url: e.target.action,
			data: obj.serialize()+"&is_ajax=28&data=approval_status&type=approval_status&form="+action,
			cache: false,
			success: function (JSON) {
				if(JSON.error != '') {
					toastr.error(JSON.error);
					...
					$('input[name="csrf_hrsale"]').val(JSON.csrf_hash);
					$('.icon-spinner3').hide();
					jQuery('#approval_status')[0].reset(); // To reset form fields
					jQuery('.save').prop('disabled', false);
				}
			}
		});
	...
	$("#delete_record").submit(function(e){
		...
		// luffy 31 December 2019 12:12 pm for deletion approver in "Approval List" section.
		else if(tk_type == 'approver'){
			var field_add = '&is_ajax=48&data=delete_approver&type=delete_record&';
			var tb_name = 'xin_table_'+tk_type;
