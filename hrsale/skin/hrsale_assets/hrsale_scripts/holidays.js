$(document).ready(function() {
	...
	$("#xin-form").submit(function(e){
	  e.preventDefault();
		var obj = $(this), action = obj.attr('name');
		$('.btn').prop('disabled', true); // luffy 7 January 2020 08:04 pm
		$.ajax({
			type: "POST",
			url: e.target.action,
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					$('.btn').prop('disabled', false); // luffy 7 January 2020 08:04 pm
					// luffy 7 January 2020 08:05 pm
					// clear all fields
