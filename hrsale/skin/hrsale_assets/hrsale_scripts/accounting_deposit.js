$(document).ready(function() {
  var xin_table = $('#xin_table').dataTable({
	...
	e.preventDefault();
	$('.icon-spinner3').show();
	$('.btn').prop('disabled', true); // luffy 9 January 2020 07:31 pm
	$.ajax({
		url: e.target.action,
		type: "POST",
		data:  fd,
...
$( document ).on( "click", ".delete", function() {
	...
	$('#delete_record').attr('action',base_url+'/delete_deposit/'+$(this).data('record-id'));
});
